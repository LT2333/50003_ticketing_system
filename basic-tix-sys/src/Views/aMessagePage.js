...
class AMessagePage extends Component {
  ...
  componentDidMount() {
    ...
    var reqc3 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/team/all"
    );
    ...
    var reqc4 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/team/uncomplete"
    );
    ...
    var reqc5 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/team/complete"
    );
    ...
    var reqc6 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/team/unassigned"
    );
    ...
    var reqc8 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/admin/uncomplete"
    );
    ...
    var reqc9 = unirest(
      "GET",
      "https://courier50003.herokuapp.com/portal/count/admin/complete"
    );
            ...
            <Col>
              <ButtonGroup vertical className="SideBar">
                ...
                <Button
                  className="SideBar"
                  theme="light"
                  id="adminview/uncompleteonly"
                  onClick={this.handleCat}
                >
                  Your unsolved tickets&nbsp;&nbsp;
                  <Badge pill theme="primary">
                    {this.state.countuncomplete}
                  </Badge>
                </Button>
                <Button
                  className="SideBar"
                  theme="light"
                  id="adminview/completeonly"
                  onClick={this.handleCat}
                >
                ...
                <Button
                  ...
                  onClick={this.handleCat}
                >
                  All requests in my team&nbsp;&nbsp;
                  <Badge pill theme="primary">
                    {this.state.countallTeam}
                  </Badge>
                </Button>
                <Button
                  className="SideBar"
                  ...
                  onClick={this.handleCat}
                >
                  Team's unassigned tickets&nbsp;&nbsp;
                  <Badge pill theme="primary">
                    {this.state.countunassignedTeam}
                  </Badge>
                </Button>
                <Button
                  className="SideBar"
                  ...
                  onClick={this.handleCat}
                >
                  Team's uncompleted tickets&nbsp;&nbsp;
                  <Badge pill theme="primary">
                    {this.state.countuncompleteTeam}
                  </Badge>
                </Button>
                <Button
                  className="SideBar"
                  ...
                  onClick={this.handleCat}
                >
                  Team's completed tickets&nbsp;&nbsp;
                  <Badge pill theme="primary">
                    {this.state.countcompleteTeam}
                  </Badge>
                </Button>
