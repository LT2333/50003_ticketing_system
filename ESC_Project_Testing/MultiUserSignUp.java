...
public class MultiUserSignUp {
    ...
    static String[] UnRegisteredUsername = {"HungryDuckkkkDuck","HungryDuckkkkDuckk","HungryDuckkkkDuckkk","HungryDuckkkkDuckkkk"};
    static String[] unRegisteredEmail = {"HungryDuckkkkDuck@gmail.com","HungryDuckkkkDuckk@gmail.com","HungryDuckkkkDuckkk@gmail.com","HungryDuckkkkDuckkkk@gmail.com"};
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfUsers; i++) {
            Signups[i] = new SignUp(UnRegisteredUsername[i],unRegisteredEmail[i],unRegisteredPassword);
            Signups[i].start();
        }
